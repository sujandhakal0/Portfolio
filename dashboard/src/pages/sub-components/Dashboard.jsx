...
import { clearAllApplicationErrors, deleteApplication, getAllApplications, resetapplicationSlice } from "@/store/slices/applicationSlice";
          ...
          <div className="grid auto-rows-max items-start gap-4 md:gap-8 lg:col-span-2">
            <div className="grid gap-4 sm:grid-cols-2 md:grid-cols-4 lg:grid-cols-2 xl:grid-cols-4">
              <Card className="sm:col-span-2">
                ...
                <CardFooter>
                  <Button className=" h-17 w-30" >Visit Portfolio</Button>
                </CardFooter>
              </Card>
              <Card className="flex flex-col justify-center">
                ...
                <CardFooter>
                  <Button onClick={gotoMangeProjects} className=" h-17 w-30" >Manage Projects</Button>
                </CardFooter>
              </Card>
              <Card className="flex flex-col justify-center">
                <CardHeader className="pb-2">
                ...
                <CardFooter>
                  <Button onClick={gotoMangeSkills} className=" h-17 w-30" >Manage Skill</Button>
                </CardFooter>
              </Card>
            </div>
            <Tabs>
                              ...
                              <TableRow className="bg-accent" key={element._id}>
                                ...
                                <TableCell className="md:table-cell">
                                  <Link to={`/update/projects/${element._id}`}>
                                    <Button className=" h-17 w-30" >Update</Button>
                                  </Link>
                                </TableCell>
                                <TableCell className="text-right">
                                  <Link
                                    ...
                                    target="_blank"
                                  >
                                    <Button className=" h-17 w-30">Visit</Button>
                                  </Link>
                                </TableCell>
                              </TableRow>
                            );
              ...
              <TabsContent className="grid min-[1050px]:grid-cols-2 gap-4">
                ...
                <Card>
                  <CardHeader className="px-7 flex items-center justify-between flex-row">
                    ...
                    <Button onClick={gotoMangeTimeline} className="w-fit h-17 w-30">
                      Manage Timeline
                    </Button>
                  </CardHeader>
                  <CardContent>
